package com.tmaproject.mybakingbook.data;
...
public class RecipeFakeData {
  ...
  private static final String SUCCESSFUL_RESPONSE = "[\n"
      ...
      + "  }\n"
      + "]";
  private static List<Recipe> recipeList = null;

  public static List<Recipe> getRecipeList() {
    if (recipeList == null) {
      recipeList = new Gson().fromJson(SUCCESSFUL_RESPONSE, new TypeToken<ArrayList<Recipe>>() {
      }.getType());
    }
    return recipeList;
  }
  ...
  public static Recipe getRecipeById(int id) {
    if (recipeList == null) getRecipeList();
